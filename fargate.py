        ...
        try:
            ...
            if not creds or not creds.valid:
                if creds and creds.expired and creds.refresh_token:
                    ...
                    print("Token refreshed - please update GOOGLE_TOKEN in environment")
    ...
    def upload_to_telegram(self, file_path, file_name):
        ...
        try:
            ...
            with open(file_path, 'rb') as file:
                ...
                response = requests.post(url, data=data, files=files, timeout=300)  # 5-minute timeout
        ...
        while True:
            try:
                ...
                for file in files:
                    ...
                    telegram_file_id = self.upload_to_telegram(file_path, file['name'])
                    
                    if telegram_file_id:
                        # Delete from Drive if upload was successful
                        print(f"Upload successful, deleting from Drive: {file['name']}")
                        if self.delete_from_drive(service, file['id']):
